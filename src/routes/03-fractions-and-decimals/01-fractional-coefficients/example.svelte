<script lang="ts">
	...
	const title = 'Fractional and Decimal Coefficients';
...
<article class="prose flex-center mb-8">
	...
	>
		...
		<p class="text-center max-w-prose">
			We have worked primarily with integers so far, but all the concepts that we have learned also
			apply to fractions and decimals.
		</p>
		<p class="text-center max-w-prose">
			For example, we know that {@html math('2x+3x=5x.')} In a similar fashion
			{@html math('\\frac{1}{2}x + \\frac{1}{4}x = \\frac{3}{4}x')}
			and {@html math('0.5x-0.12x=0.38x.')}
		</p>
	</section>
