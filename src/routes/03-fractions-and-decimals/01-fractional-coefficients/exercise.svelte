...
<script lang="ts">
	...
	const title = 'Solving Linear Equations With Fractional Coefficients';
	const nextSectionName = 'Decimal Coefficients Exercise';
	const nextSectionSlug = './exercise2';

	// qn props
	export let variablesJSON: string;
	let variables = JSONParse(variablesJSON) as [
		Fraction,
		Fraction,
		Fraction,
		Fraction,
